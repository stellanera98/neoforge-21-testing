...
public class ModItems {
    ...
    public static final DeferredHolder<Item, Item> ARC_TOOL_SMOKING = ITEMS.registerItem("arc_tool_smoking", Item::new, new Item.Properties().durability(64));
    ...
    public static final DeferredHolder<Item, Item> PRIMITIVE_ARC_TOOL_SMOKING = ITEMS.registerItem("primitive_arc_tool_smoking", Item::new, new Item.Properties().durability(256));
    ...
    public static final DeferredHolder<Item, Item> HELLFORGED_ARC_TOOL_SMOKING = ITEMS.registerItem("hellforged_arc_tool_smoking", Item::new, new Item.Properties().durability(1024));
